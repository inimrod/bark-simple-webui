...
def install_dependencies():
    ...
    run_cmd("git clone https://github.com/suno-ai/bark.git")
    if gpuchoice == "y":
        run_cmd("pip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu117")
